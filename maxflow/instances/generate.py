...
#            c = 2**j
#            for k in [100, 10000]:
#                par4 = ("./new_washington 4 %i %i %i %s/gm4_r%i_c%i_k%i.gr" % (r,c,k,dirname,r,c,k))
#                os.system(par4)
...
for i in range(6,10):
    for j in range(3,5):
        ...
        D = 2**j
        for k in [100,10000]:
            par5 = ("./new_washington 5 %i %i %i %s/gm5_d%i_D%i_k%i.gr" % (d,D,k,dirname,d,D,k))
            os.system(par5)
...
for i in range(6,9):
    for j in range(6,9):
        ...
        for d in range(3,5):
            D = 2**d
            for k in [100,10000]:
                par6 = ("./new_washington 6 %i %i %i %i %s/gm6_n%i_m%i_D%i_k%i.gr" % (n,m,D,k,dirname,n,m,D,k))
                os.system(par6)
...
for i in range(6,10):
    for j in range(6,10):
        ...
        for d in range(3,5):
            D = 2**d
            for k in [100,10000]:
                par7 = ("./new_washington 7 %i %i %i %i %s/gm7_n%i_m%i_D%i_k%i.gr" % (n,m,D,k,dirname,n,m,D,k))
                os.system(par7)
                par8 = ("./new_washington 8 %i %i %i %i %s/gm8_n%i_m%i_D%i_k%i.gr" % (n,m,D,k,dirname,n,m,D,k))
                os.system(par8)
...
for i in range(14,25):
    n = 2**i
    par9 = ("./new_washington 9 %i %s/gm9_n%i.gr" % (n,dirname,n))
    os.system(par9)
...
#for i in range(6,16):
#    n = 2**i
#    par10 = ("./new_washington 10 %i %s/gm10_n%i.gr" % (n,dirname,n))
#    os.system(par10)
